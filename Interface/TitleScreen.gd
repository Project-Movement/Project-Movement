...
func go_tutorial():
	var _a = get_tree().change_scene("res://Levels/Tutorial.tscn")

func go_tutorial2():
	var _a = get_tree().change_scene("res://Levels/AdvancedTutorial2.tscn")

func go_dearYouWallJump():
	var _a = get_tree().change_scene("res://Levels/DearYouWallJump.tscn")

func go_circus():
	var _a = get_tree().change_scene("res://Levels/Circus.tscn")
